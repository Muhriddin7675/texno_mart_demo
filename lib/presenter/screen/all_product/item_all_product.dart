...
Widget itemAllProduct(Products? data,VoidCallback clickItem,bool isFavorite,VoidCallback clickFavorite,bool isBasket ,VoidCallback clickBasket) {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 8,),
              Text(data?.id.toString() ?? '0',style: TextStyle(fontSize: 14),)
            ],
          ),
          Container(
            decoration: BoxDecoration(
            ...
            child: Padding(
              ...
              child: Text(
                maxLines: 1,
                "${formatInt((data?.salePrice ?? 1) ~/24)} so'mdan / 24 oy",style: const TextStyle(fontSize: 10),),
            ),
          ),
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Text(
                maxLines: 1,
                "${formatInt((data?.salePrice ?? 1) ~/12)} so'mdan / 0*0*12",style: const TextStyle(fontSize: 10),),
            ),
          ),
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("${formatInt(data?.salePrice ?? 1)} so'm",style: TextStyle(fontSize: 14,color: Colors.black),),
              Spacer(),
              Container(
                height: 28,
                width: 36,
